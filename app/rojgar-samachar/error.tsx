...
export default function RojgarSamacharError({
  error,
  reset,
}: {
    ...
    <div className="min-h-[60vh] flex items-center justify-center p-6">
      <div className="max-w-md w-full bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl border border-gray-200 dark:border-gray-700 shadow-2xl p-8 text-center">
        ...
        <h2 className="text-xl font-bold text-gray-800 dark:text-white">
          Rojgar Samachar load nahi ho paaya
        </h2>
        <p className="text-gray-600 dark:text-gray-300 mt-2 text-sm">
          Unable to load employment news. Please try again.
        </p>
        ...
        <div className="flex flex-wrap gap-3 justify-center mt-6">
          ...
          >
            <Briefcase className="w-4 h-4" /> Home
          </Link>
        </div>
      </div>
    </div>
